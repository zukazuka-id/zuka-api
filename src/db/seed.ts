...
async function seed() {
  ...
  await db.insert(invite).values([
    ...
    { id: "seed-invite-5", code: "N7B2YH4T", referrerId: "seed-member-1", status: "inactive", redeemedCount: 1, expiresAt: new Date("2026-04-30") },
    { id: "seed-invite-6", code: "L4F8PGX9", referrerId: "seed-member-1", status: "inactive", redeemedCount: 1, expiresAt: new Date("2026-04-30") },
    { id: "seed-invite-7", code: "C6M3ZJR7", referrerId: "seed-member-1", status: "inactive", expiresAt: new Date("2026-02-01") },
    { id: "seed-invite-8", code: "W2K9NQH4", referrerId: "seed-member-1", status: "inactive", expiresAt: new Date("2026-02-01") },
